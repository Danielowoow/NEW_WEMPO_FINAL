			...
			<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
				...
				<div class="logo">
					<a href="index.php">
						...
						<img src="img\imgLOG\BioLogo.svg" alt="Senati" class="logo">
				...
				<style>
					...
					.logo {
						max-width: 77%;
						/* Cambia el 20% por el porcentaje que desees */
						height: auto;
						/* Mantiene la proporción del logo */
						display: block;
						/* Hace que el logo sea un bloque (útil para centrarlo si es necesario) */
						margin: 0 auto;
						/* Centra el logo horizontalmente si su contenedor es más ancho */
					}
					...
					/* Estilos adicionales si necesitas ajustes específicos para móviles */
					@media screen and (max-width: 480px) {
						.logoCHOKLO {
							max-width: 80%;
							/* Tamaño aún más grande para dispositivos móviles */
						}
					}
				</style>
			</div>
