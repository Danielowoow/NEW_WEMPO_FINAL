...
<?php //include('navbar.php'); ?>
    <h1>Anexos</h1>
  <h1>Anexo l: Formato de Hoja de Reclamaciön del Libro de Reclamaciones</h1>
  <form action="procesar_formulario.php" method="POST">

    <fieldset>
      <legend>1. Identificación de consumidor reclamante</legend>
      ...
      <select name="selectDepartamento" id="selectDepartamento" onchange="cambia()" class="form-control" required="">
        ...
        <select class="form-control" name="selectProvincia" id="selectProvincia" onchange="cambiaDistrito()" required="">
        <option>Seleccione la Provincia</option>
        </select> 
        
        <select class="form-control" name="selectDistrito" id="selectDistrito" required=""><option>Seleccione el Distrito</option>
        </select>
        </div>
        <Script>
          function cambia()
...
function cambiaDistrito()
{
 ...
 sel_distrito.options[0].selected = true;     
      ...
      <label  for="num-doc">Nº Doc. de identidad:</label>
      <input type="number" id="num-doc" name="num-doc" required>
      ...
      <select id="sexo" name="sexo" required>
        ...
        <!-- Otras opciones de género podrían agregarse aquí -->
      </select>
      
      <label for="fecha-reclamo">Fecha de reclamación:</label>
      <input type="date" id="fecha-reclamo" name="fecha-reclamo" required>
    </fieldset>
    <fieldset>
        <legend>2. Detalle de la reclamación y pedido del consumidor</legend>
        <label for="tipo-reclamacion">Seleccione el tipo de reclamación:</label>
        <div id="tipo-reclamacion">
            <label for="reclamo">Reclamo</label>

            <input type="radio" id="reclamo" name="tipo-reclamacion" value="reclamo" required>
            <label for="queja">Queja</label>

            <input type="radio" id="queja" name="tipo-reclamacion" value="queja" required>
        </div>
    
        <label for="producto">Producto contratado:</label>
        <select id="producto" name="producto" required>
            <option value="" selected disabled>Seleccione..</option>
            <option value="Bien">Bien</option>
            <option value="Servicio">Servicio</option>
            <!-- Otros tipos de productos o servicios podrían agregarse aquí -->
        </select>
    
        <label for="monto">Monto reclamado (en soles peruanos):</label>
        <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text">S/.</span>
          </div>
          <input type="number" id="monto" name="monto" step="0.01" min="0" class="form-control" placeholder="Ingrese el monto" required>
        </div>
