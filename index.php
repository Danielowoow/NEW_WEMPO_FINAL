...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" href="assets\images\favicona.ico">
...
<body class="cnt-home">
		...
		<div class="container h-100">
			<div class="row h-100">
				...
				<div class="col-md-6 d-flex flex-column align-items-center justify-content-center">
					...
					<center>
						<div class="home__img-bg mb-4">
							<img src="img/choklitos/choclopizarra.png" alt="" class="home__img img-fluid home__img-small" id="piza">
						</div>
					</center>
					...
					<div class="text-block text-center">
						...
						<div class="home__btns">
							<a href="includes\calcu\calcu.php" class="btn btn-secondary btn-sm mb-2">
								Más información
							</a>
							<a class="btn btn-primary" href="https://4f12-190-239-93-28.ngrok-free.app/" target="_self" rel="noopener">INICIAR</a>
						</div>
					</div>
				</div>

				<!-- Columna solo con Imagen -->
				<div class="col-md-6 d-flex align-items-center justify-content-center">
					<div class="home__img-bg">
						<img src="img/choklitos/chocloconlupa.png" alt="" class="home__img img-fluid home__img-small">
					</div>
				</div>
			</div>
		</div>
	...
	<style>
		...
		.home {
			min-height: 80vh;
			/* Altura mínima del 100% del viewport */
		}
				...
				<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
					<div class="more-info-tab clearfix">
						...
						<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
							...
							<li><a href="#books" data-toggle="tab">MÁS PRODUCTOS</a></li>
							<li><a href="#furniture" data-toggle="tab">MÁS PRODUCTOS</a></li>
						</ul><!-- /.nav-tabs -->
					</div>
