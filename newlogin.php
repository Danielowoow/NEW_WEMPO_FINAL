...
if (isset($_POST['submit'])) {
    ...
    if ($query) {
        echo "<script>alert('Estás registrado con éxito ahora inicie sesión.');</script>";
    } else {
    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                <form method="post" class="sign-in-form" id="login-form">
                    ...
                    <div class="input-field">
                        ...
                        <input type="email" name="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" placeholder="CORREO ELECTRONICO" />
                    </div>
                    <div class="input-field">
                    ...
                    <style>
                        ...
                        a:hover {
                            color: #FFC107;
                            /* Color un poco más oscuro para cuando se pasa el ratón por encima */
                        }
                    </style>
                    <button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="login">INICIAR </button>
                ...
                <form class="sign-up-form" role="form" method="post" name="register" onSubmit="return valid();">
                    <h2 class="title">REGISTRATE</h2>

                    <div class="input-field">
                        <i class="fas fa-user"></i>
                        <input type="text" class="form-control unicase-form-control text-input" id="fullname" name="fullname" required="required" placeholder="NOMBRE COMPLETO"/>
                    </div>
                    <div class="input-field">
                        <i class="fas fa-envelope"></i>
                        <input type="email" class="form-control unicase-form-control text-input" id="email" onBlur="userAvailability()" name="emailid" required placeholder="CORREO ELÉCTRONICO">
                        <span id="user-availability-status1" style="font-size:12px;"></span>
                    </div>
                    <div class="input-field">
                        <i class="fas fa-user"></i>
                        <input type="text" class="form-control unicase-form-control text-input" name="contactno" id="contactno" placeholder="Numero de celular" pattern="\d{9}" title="Por favor, ingrese un DNI válido de 8 dígitos." maxlength="9" />
                    </div>
                    <div class="input-field">
                        <i class="fas fa-lock"></i>

                        <input type="password" class="form-control unicase-form-control text-input" id="password" name="password" placeholder="Contraseña" pattern=".{8,}" title="La contraseña debe contener al menos 8 caracteres" required />
                    </div>
                    <div class="input-field">
                        <i class="fas fa-lock"></i>
                        <input type="password" class="form-control unicase-form-control text-input" id="confirmpassword" name="confirmpassword" placeholder="Confirmar contraseña" pattern=".{8,}" title="Las contraseñas deben coincidir" required />
                    </div>
                    <div>
                        ...
                        <style>
                            ...
                            input[type="checkbox"] {
                                ...
                                border-radius: 5px;
                                /* esquinas redondeadas, si se prefiere */
                                outline: none;
                        ...
                        <style>
                            ...
                            .modal-header {
                                ...
                                /* color de cabecera amarillo maíz */
                                color: white;
                                border-bottom: 2px solid #e2c45a;
                            ...
                            .modal-footer {
                                padding: 15px;
                                background-color: #f2dc6d;
                                /* color de pie de página amarillo maíz */
                                color: white;
                                text-align: right;
                                border-top: 2px solid #e2c45a;
                                /* borde más oscuro para profundidad */
                            }

                            /* Botón de aceptar en el modal */
                            #acceptTerms {
                                background-color: #4da36e;
                                /* color verde maíz */
                                color: white;
                                padding: 10px 24px;
                                border: none;
                        ...
                        <style>
                            ...
                            label[for="terms"] {
                                font-size: 22px;
                                /* Hace el texto un poco más grande; ajusta según tus preferencias */
                                cursor: pointer;
                                /* Cambia el cursor a una 'mano' cuando se pasa sobre el texto para indicar que es clickeable */
                            }

                            /* Estilos específicos para el enlace dentro de la etiqueta */
                            label[for="terms"] a {
                                color: #FFEB3B;
                                /* Generalmente, el azul es reconocido como un color estándar para los enlaces, pero esto se puede cambiar */
                                text-decoration: underline;
                                /* Subraya el texto para indicar que es un enlace */
                                font-weight: bold;
                                /* Hace que el texto sea negrita. Esto es opcional, según tu diseño preferido */
                                transition: color 0.3s ease;
                                /* Una transición suave para el color del enlace al pasar el mouse */
                            }

                            /* Cambia el color del enlace al pasar el cursor sobre él para una retroalimentación visual */
                            label[for="terms"] a:hover,
                            label[for="terms"] a:focus {
                                /* No olvides los estilos para cuando el enlace está activo o en foco */
                                color: #002266;
                                /* Un color diferente para cuando se pasa el mouse sobre el enlace; elige el color que prefieras */
                            }
                        </style>
                    </div>
                    <button type="submit" name="submit" class="btn solid btn-upper btn btn-primary checkout-page-button" id="submit">REGISTRAR </button>
        ...
        <div class="panels-container">
            ...
            <div class="panel left-panel">
                ...
                <img src="img\choklitos\crearcuentachoclo.png" class="image" alt="">
            </div>
            ...
            <div class="panel right-panel">
                ...
                <img src="img\choklitos\Choclosesioniniciar.png" class="image" alt="">
            </div>
        </div>
    </div>
